...
$sql = "SELECT id, teacher_name, subject, lecture_date, start_time, end_time, classroom FROM timetable3";
...
<div class="text-center">
    <h2 class="text-white mt-4" style="display: inline-block; background-color: rgb(57, 227, 60); padding: 2px 5px;">
    地域観光デザイン－１年
    </h2>
</div>
<div class="container">
    <div class="d-flex justify-content-end">
        <a href="csv3.php" class="btn btn-primary me-3 btn-iica">CSVを導入</a>
    </div>
