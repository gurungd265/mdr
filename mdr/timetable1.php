...
$sql = "SELECT id, teacher_name, subject, lecture_date, start_time, end_time, classroom FROM timetable1";
...
<div class="text-center">
    <h2 class="text-white mt-4" style="display: inline-block; background-color: rgb(57, 167, 152); padding: 2px 5px;">
        ITソリューション－１年
    </h2>
</div>
<div class="container">
    <div class="d-flex justify-content-end">
        <a href="csv1.php" class="btn btn-primary me-3 btn-iica">CSVを導入</a>
    </div>
