...
$sql = "SELECT subject.id, subject.subject_name, subject.teacher_id, subject.subject_code, teacher.name, teacher.sensei_id 
        FROM subject
...
<body>
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>科目一覧</h2>
            <!-- Add New button -->
            <a href="add_subject.php" class="btn text-white btn-iica">科目を追加</a>
        </div>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $row['sensei_id']; ?></td>
                            <td><?php echo $row['subject_code']; ?></td>
                            <td><?php echo $row['name']; ?></td>

                            <td>
                                <!-- Edit button -->
                                <a href="edit_subject.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">変更</a>
