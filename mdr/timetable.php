...
<div class="text-center">
    <h2 class="text-white mt-4" style="display: inline-block; background-color: rgb(198, 30, 153); padding: 2px 5px;">
        ITソリューション－２年
    </h2>
</div>
<div class="container">
    <div class="d-flex justify-content-end">
        <a href="csv.php" class="btn btn-primary me-3 btn-iica">CSVを導入</a>
    </div>
