...
<head>
    ...
    <script>
        ...
        function confirmDelete() {
            return confirm("この教師の情報を削除してもよろしいですか？?");
        }
...
<body>
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>講師一覧</h2>
            <!-- Add New button -->
            <a href="add_teacher.php" class="btn btn-primary btn-iica">講師を追加</a>
        </div>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $row['kyori']; ?></td>
                            <td>
                                <!-- Edit button -->
                                <a href="edit_teacher.php?id=<?php echo $row['teacher_id']; ?>" class="btn btn-warning btn-sm">変更</a>
